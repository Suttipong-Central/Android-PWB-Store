...
public class ClearAbleEditText extends PowerBuyEditText implements View.OnTouchListener, View.OnFocusChangeListener, PowerBuyTextWatcherAdapter.PowerBuyTextWatcherListener{
    ...
    private void init() {
        ...
        addTextChangedListener(new PowerBuyTextWatcherAdapter(this, this));
        initIcon();
        setClearIconVisible(false);
    }
