...
public class ProductGridSpacesItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public ProductGridSpacesItemDecoration(Context context, @DimenRes int spacingDimen) {

        spacing = context.getResources().getDimensionPixelSize(spacingDimen);
        halfSpacing = spacing / 2;
    }

    public ProductGridSpacesItemDecoration(int spacingPx) {
    ...
    protected void setSpacings(Rect outRect, RecyclerView parent, int childCount, int childIndex, RecyclerView.ViewHolder childViewHolder, int itemSpanSize, int spanIndex) {
        if (!(childViewHolder instanceof ProductOverviewViewHolder ||
                childViewHolder instanceof ProductPromotionViewHolder ||
                childViewHolder instanceof ProductDetailImageViewHolder ||
                childViewHolder instanceof ProductDetailDescriptionViewHolder ||
                childViewHolder instanceof ProductSpecViewHolder ||
                childViewHolder instanceof ProductDeliveryViewHolder ||
                childViewHolder instanceof ProductRecommendListViewHolder))
        {
