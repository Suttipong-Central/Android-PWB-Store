...
public class ProductDetailStore implements IViewType,Parcelable {
    ...
    protected ProductDetailStore(Parcel in) {
    ...
    public static final Creator<ProductDetailStore> CREATOR = new Creator<ProductDetailStore>() {
        @Override
        public ProductDetailStore createFromParcel(Parcel in) {
            return new ProductDetailStore(in);
        }

        @Override
        public ProductDetailStore[] newArray(int size) {
            return new ProductDetailStore[size];
        }
    };
