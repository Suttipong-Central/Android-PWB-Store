...
public class CompareListStore implements IViewType,Parcelable {
    ...
    protected CompareListStore(Parcel in) {
    ...
    public static final Creator<CompareListStore> CREATOR = new Creator<CompareListStore>() {
        @Override
        public CompareListStore createFromParcel(Parcel in) {
            return new CompareListStore(in);
        }

        @Override
        public CompareListStore[] newArray(int size) {
            return new CompareListStore[size];
        }
    };
