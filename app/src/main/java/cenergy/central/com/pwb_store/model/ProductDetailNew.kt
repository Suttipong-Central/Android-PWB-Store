...
class ProductDetailNew() : Parcelable,IViewType {
    ...
    companion object CREATOR : Parcelable.Creator<ProductDetailNew> {
        override fun createFromParcel(parcel: Parcel): ProductDetailNew {
            return ProductDetailNew(parcel)
        }

        override fun newArray(size: Int): Array<ProductDetailNew?> {
