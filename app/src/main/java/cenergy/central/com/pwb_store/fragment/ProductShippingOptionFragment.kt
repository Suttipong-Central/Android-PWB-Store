...
class ProductShippingOptionFragment : Fragment(), CalendarViewCustom.OnItemClickListener {
    ...
    private fun createShippingData(setFirstDayAndLastDay: Boolean) {
        ...
        for (day in nextPreWeekday) {
            ...
            if (currentDay != null) {
                var itemA = ShippingItem(0, getString(R.string.full))
                var itemB = ShippingItem(0, getString(R.string.full))
                var itemC = ShippingItem(0, getString(R.string.full))
                var itemD = ShippingItem(0, getString(R.string.full))
                var itemE = ShippingItem(0, getString(R.string.full))
                var itemF = ShippingItem(0, getString(R.string.full))
                var itemG = ShippingItem(0, getString(R.string.full))
                var itemH = ShippingItem(0, getString(R.string.full))
                var itemI = ShippingItem(0, getString(R.string.full))
                var itemJ = ShippingItem(0, getString(R.string.full))
                var itemK = ShippingItem(0, getString(R.string.full))
                var itemL = ShippingItem(0, getString(R.string.full))
                var itemM = ShippingItem(0, getString(R.string.full))
                var itemN = ShippingItem(0, getString(R.string.full))
                var itemO = ShippingItem(0, getString(R.string.full))
                var itemP = ShippingItem(0, getString(R.string.full))
                var itemQ = ShippingItem(0, getString(R.string.full))
                var itemR = ShippingItem(0, getString(R.string.full))
